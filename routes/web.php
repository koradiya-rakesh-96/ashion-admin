...
use App\Http\Controllers\admin\ContactUsContoller;
...
Route::group(['prefix' => 'account'],function(){
    ...
    Route::group(['middleware' => 'auth'],function(){
        Route::get('/profile',[AuthController::class,'profile'])->name('account.profile');
        Route::post('/update-profile',[AuthController::class,'profileUpdate'])->name('account.profileUpdate');
        Route::post('/update-address',[AuthController::class,'addressUpdate'])->name('account.addressUpdate');
        ...
        Route::get('/order-cancel/{orderId}',[AuthController::class,'orderCancel'])->name('account.orderCancel');
        Route::get('/logout',[AuthController::class,'logout'])->name('account.logout');
        Route::get('/change-password',[AuthController::class,'showChangePassword'])->name('account.changePassword');
...
Route::group(['prefix' => 'admin'],function(){
    ...
    Route::group(['middleware' => 'admin.auth'],function(){
        ...
        //Process Change Password Admin
        Route::post('/process-change-password',[SettingController::class,'processChangePassword'])->name('admin.processChangePassword');

        //Contact-us Routes
        Route::get('/contact-us',[ContactUsContoller::class,'index'])->name('contact.index');
