                        ...
                        @if($discountCoupons->isNotEmpty())
                            @foreach ($discountCoupons as $discountCoupon)
                                <tr>
                                    ...
                                    <td>{{ (!empty($discountCoupon->starts_at)) ? \Carbon\Carbon::parse($discountCoupon->starts_at)->format('d/m/Y H:i:s') : '' }}</td>
                                    <td>{{ (!empty($discountCoupon->expires_at)) ? \Carbon\Carbon::parse($discountCoupon->expires_at)->format('d/m/Y H:i:s') : '' }}</td>
                                    <td>
