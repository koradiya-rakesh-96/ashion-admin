<ul id="account-panel" class="nav nav-pills flex-column" >
    ...
    <li class="nav-item {{ (request()->routeIs('account.orders') || request()->routeIs('account.orderDetail')) ? 'active' : ''}}">
    ...
    <li class="nav-item {{ request()->is('account/my-wishlist') ? 'active' : ''}}">
    ...
    <li class="nav-item {{ request()->is('account/change-password') ? 'active' : ''}}">
