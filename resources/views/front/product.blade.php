                    ...
                    <div id="product-carousel" class="carousel slide" data-bs-ride="carousel">
                        <div class="carousel-inner bg-light">
                            @if ($product->product_images && count($product->product_images) > 0)
                                ...
                                @endforeach
                            @else
                                <img class="w-100 h-100" src="{{ asset('admin-assets/img/noImg.jpg') }}" />
                            @endif
                        </div>
                        ...
                        @foreach ($relatedProducts as $item)    
                            ...
                            <div class="card product-card">
                                <div class="product-image position-relative">
                                    ...
                                    <a class="whishlist" onclick="addToWishList({{$item->id}})" href="javascript:void(0)"><i class="far fa-heart"></i></a> 
