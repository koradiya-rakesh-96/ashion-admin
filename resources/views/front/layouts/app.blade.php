...
<html class="no-js" lang="en_AU" />
    ...
    <body data-instant-intensity="mousedown">
        ...
        <header class="bg-dark" style="position: sticky; top: 0; z-index: 1000;">
            <div class="container">
                <nav class="navbar navbar-expand-xl" id="navbar">
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                            ...
                            <li class="nav-item">
                                <a href="{{ route('front.shop') }}" class="nav-link {{ request()->route()->getName() === 'front.shop' ? 'active' : ''}}">Shop</a>
                            </li>
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="footer-card">
                            <h3>Get In Touch</h3>
                            <p>AmazingOnlineShop By Rupesh Jadhav. <br>
                            123 Street, New York, USA <br>
                            rcjadhav@gmail.com <br>
                            079 164 2538</p>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-12 mt-3">
                            <div class="copy-right text-center">
                                <p>© Copyright {{ date('Y') }} AmazingOnlineShop. All Rights Reserved</p>
                            </div>
                        </div>
                    </div>
                </div>
