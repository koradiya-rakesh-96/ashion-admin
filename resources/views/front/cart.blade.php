                                    ...
                                    <tr>
                                        <td class="text-start">
                                            <div class="d-flex align-items-center">
                                                ...
                                                @else
                                                    <img src="{{ asset('admin-assets/img/noImg.jpg') }}" />
                                                @endif
                                                <h2>{{ $item->name }}</h2>
                                            </div>
                                        </td>
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-body d-flex justify-content-center">
                            ...
                            <h4 style="margin-left: 7px;">Click <a href="{{route('front.shop')}}">here</a> to shopping </h4>
                        </div>
                    </div>
                </div>
            @endif
...
@section('customJs')
    <script>
        ...
        function updateCart(rowId,qty) {
            //alert(rowId);alert(qty);return false;
            $.ajax({
